...
start:
    ...
    ; --- Replace below code with assembly instructions taken from the crackme14 ---
    mov dword [ebp-5Ch],0FFFFFFFFh
    lea eax,dword [ebp-2Ch]
    mov dword [esp],eax
    call [GetLocalTime]
    sub esp,4h
    movzx eax,word [ebp-2Ch]
    add eax,4D2h
    movzx ecx,word [ebp-2Ah]
    movzx edx,word [ebp-26h]
    ; --- end Replace ---
